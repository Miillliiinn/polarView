...
async function fetchZoneWithFallback(zone) {
    try {
...
async function fetchAdsbStates(zones = exports.DEFAULT_FRANCE_ZONES) {
    try {
        const byHex = new Map();
