...
const openskyScript_1 = require("./script/planes/openskyScript");
const sncfScript_1 = require("./script/trains/sncfScript");
const meteofranceScript_1 = require("./script/weather/meteofranceScript");
const prisma_service_1 = require("../prisma/prisma.service");
const googleScript_1 = require("./script/webcams/googleScript");
const schedule_1 = require("@nestjs/schedule");
const gareScript_1 = require("./script/trains/gareScript");
